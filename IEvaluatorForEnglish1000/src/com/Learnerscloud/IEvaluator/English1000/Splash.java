...
public class Splash extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cache.setDataBaseVersion(5); // This is now to upgrade the database Just increase by 1 and make sure DBVersion- VersionNumber in database is updated. 
			...
			public void run(){
		 	...
		 	/*try {
		 		...
		 		throw sqle;
					...
					Intent OpenStartPage = new Intent("com.Learnerscloud.IEvaluator.English1000.TABS");
