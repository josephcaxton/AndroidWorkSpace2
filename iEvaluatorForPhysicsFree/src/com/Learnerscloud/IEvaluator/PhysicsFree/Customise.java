package com.Learnerscloud.IEvaluator.PhysicsFree;
...
import com.Learnerscloud.IEvaluator.PhysicsFree.R;
...
public class Customise extends ActivityGroup implements OnClickListener,OnSeekBarChangeListener {
	...
	private static final int MAXIMUMQUESTIONS = 30;
	...
	public void onClick(View v) {
		...
		case(R.id.btnCustomise):
			...
			//Intent ChangeDifficultyIntent = new Intent("com.learnersCloud.iEvaluator.MathsFree.CHANGEDIFFICULTYACTIVITY");
			//TabGroupActivity parentActivity = (TabGroupActivity)getParent(); 
			//startActivity(ChangeDifficultyIntent);
			
			Intent CustomiseIntent = new Intent("com.Learnerscloud.IEvaluator.PhysicsFree.CONFIGURE");
