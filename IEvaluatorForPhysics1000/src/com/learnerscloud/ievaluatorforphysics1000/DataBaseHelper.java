...
public class DataBaseHelper extends SQLiteOpenHelper{
    ...
    private static String DB_PATH = "/data/data/com.learnerscloud.ievaluatorforphysics1000/databases/";
 
    private static String DB_NAME = "GCSEPhysics.sqlite";
...
public static void backupDatabase() throws IOException {
    //Open your local db as the input stream
    String inFileName = "/data/data/com.learnerscloud.ievaluatorforphysics1000/databases/TempDB.sqlite";
