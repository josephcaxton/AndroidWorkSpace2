...
public class DataBaseHelper extends SQLiteOpenHelper{
    ...
    private static String DB_PATH = "/data/data/com.Learnerscloud.IEvaluator.English750/databases/";
...
public static void backupDatabase() throws IOException {
    //Open your local db as the input stream
    String inFileName = "/data/data/com.Learnerscloud.IEvaluator.English750/databases/TempDB.sqlite";
